...
export const regionDepth = {
  ...
  alentejo: {
    caseStudy: '#alentejo',
    asks: "Alentejo asks you to design from the rainwater equation backward: 500 to 650 mm a year, nearly all falling between October and April, means cisterns sized for six dry months and shade treated as infrastructure, not scenery. Purchase is open freehold, but RAN-classified agricultural parcels transact freely while often forbidding residential construction outright, so verify RAN and REN status and any water rights before buying, not after. The living context is the cork-oak montado with its shared water and fire discipline, thirty years of Tamera nearby, and sparse ageing villages where rooting in matters more than fencing off a herdade.",
    source: "Portuguese Land Law DL 555/99 (consolidated)",
    sourceUrl: "https://dre.pt/web/guest/legislacao-consolidada/-/lc/34465475/view",
  },
  connemara: {
    caseStudy: '#connemara',
    asks: "Connemara asks you to treat blanket bog as a body of stored carbon rather than a foundation: buildings that float rather than press, drainage that works with the watershed, and designs that never open century-deep peat. Anyone may buy land, but lawful residence is gated by restrictive one-off rural-housing planning, and in the Gaeltacht core the planning system adds Irish-language and community-commitment criteria, so the learning is done in Irish. Water is the opposite of scarce at 1,200 to 2,400 mm a year; the real design constraints are Atlantic storm exposure, wet winters, and an energy strategy that leans on coastal wind rather than solar.",
    source: "Cork County Development Plan 2022–2028",
    sourceUrl: "https://www.corkcoco.ie/en/cork-county-development-plan-2022-2028",
  },
  transylvania: {
    caseStudy: '#transylvania',
    asks: "Transylvania asks for continuation rather than invention: the hay-meadow biodiversity holds because someone mows, and the project that thrives is one the village can recognise as adjacent to its own. EU citizens buy freehold while non-EU buyers hold through a Romanian SRL, and Law 17/2014 adds a 45-day pre-emption notice in which co-owners, lessees, neighbours, and young farmers hold first claim. Water and soils are generous by EU standards, so the physical work is continental: winters that bottom at minus 10 to minus 15 Celsius, firewood as the practical winter backbone, and the composesorat commons setting the relational terms of entry.",
  ...
  asturias: {
    ...
    sourceUrl: "https://www.mapa.gob.es/dam/mapa/contenido/estadisticas/temas/estadisticas-agrarias/1.economicas/precios-medios-anuales-de-las-tierras-de-uso-agrario/precios-medios-anuales-de-las-tierras-de-uso-agrario--resultados-2024-1.pdf",
  },
  "saxony-anhalt": {

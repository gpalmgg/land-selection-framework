...
- **Description:** When ≥1 region passes the active thresholds, a contextual next-step row appears on/near the match bar with: "What they ask of you" (opens first passing region's drawer), "Share this view" (copies the full URL), "Talk to The Collective" (existing contact gustaf@islands-of-coherence.com).
- **Setup:** shared server.
